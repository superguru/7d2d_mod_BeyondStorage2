...
public static class ServerUtils {
    ...
    public static void PlayerSpawnedInWorld(ref SPlayerSpawnedInWorldData data) {
        ...
        if (LogUtil.IsDebug()) LogUtil.DebugLog($"client {data.ClientInfo}; isLocalPlayer {data.IsLocalPlayer}; entityId {data.EntityId}; respawn type {data.RespawnType}; pos {data.Position}");
        ...
        if (ModConfig.ServerSyncConfig()) data.ClientInfo.SendPackage(NetPackageManager.GetPackage<NetPackageBeyondStorageConfig>());
    }
