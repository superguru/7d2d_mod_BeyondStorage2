...
public sealed class TimeBasedDictionaryCache<TKey, TValue>
{
    ...
    /// <summary>
    /// Initializes a new instance of the TimeBasedDictionaryCache.
    /// </summary>
    ...
    public TimeBasedDictionaryCache(double cacheDurationSeconds, string cacheTypeName = null)
    {
